    ...
    <>
      <div className="min-h-screen min-w-min place-content-center">
        ...
        <div className="">
          <div className=" flex flex-wrap ">
            ...
            <div className="flex flex-wrap ml-3">
              ...
              <div>
              <button onClick={filterTodos} className="bg-indigo-50 focus:ring-indigo-400 focus:ring border-1 border-indigo text-black font-semibold  border-indigo rounded-md p-1 ml-5 px-3 py-1.5">
                Filter Todos
              </button>
            </div>
        ...
        <div className="mt-16 ml-96 ">
          <button onClick={updatevalue} className="bg-sky-500 hover:bg-sky-700  border-2 border-slate-600 text-white font-semibold rounded-md  p-2 px-8 py-2 content-end mt-6 m-4  place-items-end  ">
            Save
          </button>
        </div>
      </div>
          ...
          <div className="flex justify-evenly my-9">
            ...
            <button  className=" bg-indigo-300 focus:ring-indigo-600 focus:ring border-2 border-indogo p-2 px-8 rounded-full py-2" onClick={() => handleWeekdayButtonClick("")}>All</button>
          </div>
        {!isfiltered
          ? todos.map((item) => (
            <div className="border border-blue-500 rounded-md mt-5 flex justify-between m-4" key={item.id}>
            <div>
            ...
            <div className="mt-12 m-2">
              <button className="bg-indigo-50 border-2 border-indigo hover:bg-red-700 hover:text-white px-4 rounded-md p-1 ml-5" onClick={() => handleDelete(item.id)}>Delete</button>
            </div>
          </div>
            ))
          : filteredTodos.map((item) => {
              return (
                ...
                <div className="mt-12 m-2">
                  <button className="bg-indigo-50  hover:bg-red-700 hover:text-white border-2 border-indigo  rounded-md p-1 ml-5 px-4" onClick={() => handleDelete(item.id)}>Delete</button>
                </div>
              </div>
